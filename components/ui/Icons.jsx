      ...
      <span className={classnames('svg-icon-wrapper', className, active && 'active')}>
        <svg {...rest} className={classnames('svg-icon', type && 'svg-icon-' + type)}>
          {(() => {
            switch (type) {
            case 'pause':
              return <path d={'M26 15 8 4 8 26 26 15 26 15'} />
            case 'play':
              return <path d={'M5 5 5 25 25 25 25 5 5 5'} />
            case 'left-arrow':
              return <path d={'M 20 5 10 15 20 25'} />
            case 'right-arrow':
              return <path d={'M 10 5 20 15 10 25'} />
            case 'top-arrow':
              return <path d={'M 5 20 15 10 25 20'} />
            case 'menu':
              return <path d={'M5 7 25 7  M5 15 25 15 M5 23 25 23'} />
            case 'close':
              return <path d={'M7 7 23 23 M15 15 15 15 M23 7 7 23'} />
            case 'bars':
              return <path d={'M5 25 5 15 M15 25 15 10 M25 25 25 5'} />
            }
          })()}
        </svg>
      </span>
